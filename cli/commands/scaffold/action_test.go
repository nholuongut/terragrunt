...
func TestDefaultTemplateVariables(t *testing.T) {
	...
	vars["sourceUrl"] = "git::https://github.com/nholuongut/terragrunt.git//test/fixtures/inputs?ref=v0.53.8"
	...
	require.Equal(t, "git::https://github.com/nholuongut/terragrunt.git//test/fixtures/inputs?ref=v0.53.8", *cfg.Terraform.Source)
