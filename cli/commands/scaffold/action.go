...
// github.com/nholuongut/terragrunt.git//test/fixtures/inputs => git::https://github.com/nholuongut/terragrunt.git//test/fixtures/inputs
func rewriteModuleURL(opts *options.TerragruntOptions, vars map[string]interface{}, moduleURL string) (*url.URL, error) {
	...
	// git::https://github.com/nholuongut/terragrunt.git//test/fixtures/inputs => git::ssh://git@github.com/nholuongut/terragrunt.git//test/fixtures/inputs
...
func addRefToModuleURL(ctx context.Context, opts *options.TerragruntOptions, parsedModuleURL *url.URL, vars map[string]interface{}) (*url.URL, error) {
	...
	if ref == "" {
		...
		// git::https://github.com/nholuongut/terragrunt.git//test/fixtures/inputs => git::https://github.com/nholuongut/terragrunt.git//test/fixtures/inputs?ref=v0.53.8
