...
import (
	...
	tgTerraform "github.com/nholuongut/terragrunt/terraform"
...
func TestDownloadTerraformSourceIfNecessaryRemoteUrlToEmptyDir(t *testing.T) {
	...
	canonicalURL := "github.com/nholuongut/terragrunt//test/fixtures/download-source/hello-world"
	downloadDir := tmpDir(t)
	defer os.Remove(downloadDir)
...
func TestDownloadTerraformSourceIfNecessaryRemoteUrlToAlreadyDownloadedDirDifferentVersion(t *testing.T) {
	...
	canonicalURL := "github.com/nholuongut/terragrunt//test/fixture-download-source/hello-world?ref=v0.9.7"
	downloadDir := tmpDir(t)
	defer os.Remove(downloadDir)
...
func TestInvalidModulePath(t *testing.T) {
	...
	canonicalURL := "github.com/nholuongut/terragrunt//test/fixture-download-source/hello-world-version-remote/not-existing-path?ref=v0.9.7"
	downloadDir := tmpDir(t)
	defer os.Remove(downloadDir)
...
func TestDownloadInvalidPathToFilePath(t *testing.T) {
	...
	canonicalURL := "github.com/nholuongut/terragrunt//test/fixture-download-source/hello-world/main.tf?ref=v0.9.7"
	downloadDir := tmpDir(t)
	defer os.Remove(downloadDir)
