...
func TestWindowsScaffold(t *testing.T) {
	...
	runTerragrunt(t, fmt.Sprintf("terragrunt scaffold github.com/nholuongut/terragrunt-infrastructure-modules-example//modules/mysql --terragrunt-working-dir %s", tmpDir))
...
func TestWindowsScaffoldRef(t *testing.T) {
	...
	runTerragrunt(t, fmt.Sprintf("terragrunt scaffold github.com/nholuongut/terragrunt-infrastructure-modules-example//modules/mysql?ref=v0.8.1 --terragrunt-working-dir %s", tmpDir))
