...
```hcl
engine {
  source  = "github.com/nholuongut/terragrunt-engine-opentofu"
  version = "v0.0.7"
}
```

This example leverages the official OpenTofu engine, [publicly available on GitHub](https://github.com/nholuongut/terragrunt-engine-opentofu).
...
```hcl
engine {
  source  = "https://github.com/nholuongut/terragrunt-engine-opentofu/releases/download/v0.0.5/terragrunt-iac-engine-opentofu_rpc_v0.0.5_linux_amd64.zip"
}
