...
import (
	...
	"github.com/nholuongut/terragrunt/cli/commands/terraform/creds"
	"github.com/nholuongut/terragrunt/cli/commands/terraform/creds/providers/amazonsts"
	"github.com/nholuongut/terragrunt/cli/commands/terraform/creds/providers/externalcmd"
	...
	"github.com/nholuongut/terragrunt/terraform"
...
func getOutputJSONWithCaching(ctx *ParsingContext, targetConfig string) ([]byte, error) {
	...
	// Related issues: https://github.com/nholuongut/terragrunt/issues/2233 https://github.com/hashicorp/terraform-provider-aws/issues/23620
...
func cloneTerragruntOptionsForDependency(ctx *ParsingContext, targetConfigPath string) (*options.TerragruntOptions, error) {
	...
	// https://github.com/nholuongut/terragrunt/issues/1853#issuecomment-940102676
