...
type TerragruntOptions struct {
	...
	// If set to true, continue running *-all commands even if a dependency has errors. This is mostly useful for 'output-all <some_variable>'. See https://github.com/nholuongut/terragrunt/issues/193
...
func (opts *TerragruntOptions) Clone(terragruntConfigPath string) (*TerragruntOptions, error) {
	...
	// during xxx-all commands (e.g., apply-all, plan-all). See https://github.com/nholuongut/terragrunt/issues/367
	// for more info.
	return &TerragruntOptions{
